...
class PeriodicExtractor:
    """Streaming extractor for the periodic task model with release jitter and offset."""
    ...
    def __init__(
        ...
        self._current_batch: list[tuple[int, Instant]] = []
    ...
    def feed(self, releases: Iterable[Instant]) -> None:
        ...
        i = None
        for i, r in enumerate(releases, start=self._next_idx):
